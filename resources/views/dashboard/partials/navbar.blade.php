            ...
            {{-- <ul class="nav navbar-nav">
                <li class="nav-item d-none d-lg-block"><a class="nav-link bookmark-star"><i class="ficon text-warning fa-solid fa-star"></i></a>
                    <div class="bookmark-input search-input">
                        <div class="bookmark-input-icon"><i class="fa-solid fa-search"></i></div>
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            {{-- <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon fa-solid fa-search"></i></a>
                <div class="search-input">
                    <div class="search-input-icon"><i class="fa-solid fa-search"></i></div>
                    <input class="form-control input" type="text" placeholder="Explore Vuexy..." tabindex="-1" data-search="search">
                    <div class="search-input-close"><i class="fa-solid fa-xmark"></i></div>
                    <ul class="search-list search-list-main"></ul>
                </div>
            </li> --}}
            {{-- <li class="nav-item dropdown dropdown-cart me-25"><a class="nav-link" href="#" data-bs-toggle="dropdown"><i class="ficon fa-solid fa-cart-shopping"></i><span class="badge rounded-pill bg-primary badge-up cart-item-count">6</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    <li class="scrollable-container media-list">
                        <div class="list-item align-items-center"><img class="d-block rounded me-1" src="{{asset('dashboard')}}/app-assets/images/pages/eCommerce/1.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove fa-solid fa-xmark"></i>
            ...
            {{-- <li class="nav-item dropdown dropdown-notification me-25"><a class="nav-link" href="#" data-bs-toggle="dropdown"><i class="ficon fa-solid fa-bell"></i><span class="badge rounded-pill bg-danger badge-up">5</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    <li class="dropdown-menu-header">
                        <div class="dropdown-header d-flex">
                    ...
                    <li class="scrollable-container media-list"><a class="d-flex" href="#">
                        ...
                        <div class="list-item d-flex align-items-center">
                            ...
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar bg-light-danger">
                                        <div class="avatar-content"><i class="avatar-icon fa-solid fa-xmark"></i></div>
                                    </div>
                                </div>
                                <div class="list-item-body flex-grow-1">
                            ...
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar bg-light-success">
                                        <div class="avatar-content"><i class="avatar-icon fa-solid fa-check"></i></div>
                                    </div>
                                </div>
                                <div class="list-item-body flex-grow-1">
                            ...
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar bg-light-warning">
                                        <div class="avatar-content"><i class="avatar-icon fa-solid fa-triangle-exclamation"></i></div>
                                    </div>
                                </div>
                                <div class="list-item-body flex-grow-1">
...
<!--                    <a class="dropdown-item" href="#"><i class="me-50 fa-solid fa-circle-question"></i> FAQ</a>-->
                    <form method="POST" action="{{ route('dashboard.logout') }}">
                        ...
                        <a class="dropdown-item" onclick="event.preventDefault(); this.closest('form').submit();"
                            href="{{ route('dashboard.logout') }}"><i class="me-50 fa-solid fa-power-off"></i> {{__('auth.logout')}}</a>
                    </form>
                </div>
            </li>
        </ul>
...
<ul class="main-search-list-defaultlist-other-list d-none">
    <li class="auto-suggestion justify-content-between"><a class="d-flex align-items-center justify-content-between w-100 py-50">
            <div class="d-flex justify-content-start"><span class="me-75 fa-solid fa-circle-exclamation"></span><span>No results found.</span></div>
        </a></li>
</ul> --}}
